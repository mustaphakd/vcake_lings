...
class UsersFixture extends  TestFixture
{
    ...
    public  function init()
    {
        ...
        $this->records = [
            ...
            ['id' => $uids[2], 'first_name' => "Mohammed", 'last_name' => 'Iniankebou', 'email' => 'mohammed@wrsft.com', 'account_confirmation_hash' => Text::uuid(), 'confirmed' => 'T', 'disabled' => 'F', 'created' => Time::now(), 'modified' => Time::now(), 'password' => $hasher, 'password_reset_hash' => Text::uuid(), 'birth_date' => (new Date('1990-02-22'))->format('Y-m-d H:i:s') ],
